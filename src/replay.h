...
struct SlippiReplay {
  ...
  int8_t          items_on            = 0;
  int8_t          sd_score            = 0;
  uint8_t         timer_behav         = false;
  uint8_t         ui_chars            = false;
  uint8_t         game_mode           = false;
  bool            friendly_fire       = false;
  bool            demo_mode           = false;
  bool            classic_adv         = false;
  bool            hrc_event           = false;
  bool            allstar_wait1       = false;
  bool            allstar_wait2       = false;
  bool            allstar_game1       = false;
  bool            allstar_game2       = false;
  bool            single_button       = false;
  bool            pause_timer         = false;
  bool            pause_nohud         = false;
  bool            pause_lras          = false;
  bool            pause_off           = false;
  bool            pause_zretry        = false;
  bool            pause_analog        = false;
  bool            pause_score         = false;
  uint8_t         items1              = false;
  uint8_t         items2              = false;
  uint8_t         items3              = false;
  uint8_t         items4              = false;
  uint8_t         items5              = false;
